...
const HowToUseDetailsScreen = props => {
  ...
  return (
    <View nestedScrollEnabled={true} style={styles.mainContaier}>
      <View
        ...
        >
          ...
          <Text
            ...
            {props.PagesReducer.app_description.title}
          </Text>
        </ImageBackground>
      </View>
      ...
      <View style={{...styles.subitemStyle, top: -15}}>
        <ScrollView
          ...
          {/* <View style={{
                        ...
                        <Text style={{ ...styles.titleTextStyle, }}> 1 hour </Text>
      ...
      /> */}
          ...
          {props.PagesReducer.app_description.content != undefined &&
                ...
                source={{
                  html: `<!DOCTYPE html>\n
                      <html><head>
                        ...
                        </head>  <body>${props.PagesReducer.app_description.content}</body></html>`,
                }}
          ...
          {/* <Text style={{ ...styles.linkText, color: config.colors.darkGrayColor, fontSize: 15 }}> share now</Text> */}
          {/* <View
                            style={{
                                marginHorizontal: 20,
                                marginTop: 5,
...
const mapDispatchToProps = (dispatch, getState = store.getState) => ({
  getAppDescription: () => pagesActions.getAppDescription()(dispatch),
});
