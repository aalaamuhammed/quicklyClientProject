...
const NewsDetailsScreen = props => {
  const sharenow = () => {
    Share.open({
      title: props.NewsReducer.oneNews.title,
      url: props.NewsReducer.oneNews.image,
      message:
        props.NewsReducer.oneNews.title +
        '\n' +
        props.NewsReducer.oneNews.description +
        ' ' +
        lang.home.forMoreInfo,
      showAppsToView: true,
      type: 'image/jpg',
    })
      .then(res => {})
  ...
  return (
    <View nestedScrollEnabled={true} style={styles.mainContaier}>
      <ImageBackground
        ...
        source={{uri: props.NewsReducer.oneNews.image}}>
        <View
          style={{
            ...styles.viewStyle,
            justifyContent: 'space-between',
        ...
        <ScrollView style={{paddingHorizontal: 15}}>
          <View
            ...
            <Text style={{...styles.titleTextStyle}}>
              {' '}
              {props.NewsReducer.oneNews.created_at}{' '}
            </Text>
          </View>
