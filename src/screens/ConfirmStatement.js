...
const ConfirmStatementScreen = props => {
  const {
    handleSubmit,
    control,
              ...
              <View style={{padding: 10, flex: 1}}>
                {props.VoucherReducer.voucherDetails.order && (
                  <View>
                    ...
                    <View>
                      ...
                      <View style={styles.fieldContainer}>
                        <Text
                          ...
                          {props.VoucherReducer.voucherDetails.order.complaint}
                        </Text>
                      </View>
                    </View>
                    <View>
                    ...
                    {props.VoucherReducer.voucherDetails.order.warranty && (
                      <View
                        style={{
                          display: 'flex',
                          flexWrap: 'wrap',
                ...
                <View style={{justifyContent: 'center', marginVertical: 5}}>
                  {props.VoucherReducer.voucherDetails.order.company_engineers
                    .length > 0 && (
                    <View>
                      <Text
                        style={{
                        ...
                        <TouchableOpacity
                          onPress={() =>
                            props.engineerProfile({
                              data: props.VoucherReducer.voucherDetails.order
                          ...
                          <Image
                            ...
                            source={{
                              uri: props.VoucherReducer.voucherDetails.order
                          ...
                          <View style={{paddingHorizontal: 10}}>
                            ...
                            <View
                              ...
                              {/* <Rating
                                                        readonly
                                                        fractions={1}
                                                        startingValue={props.VoucherReducer.voucherDetails.order.company_engineers[0].rate}
                ...
                {/* {props.VoucherReducer.voucherDetails.order.coupon_discount==null &&  <View>
                                <View>
                                    <View style={{ display: 'flex', flexWrap: 'wrap', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginVertical: 5 }}>
                                        <View style={{ marginHorizontal: 5 }}>
                                            <Text
                                                style={{
                                                    ...styles.titleTextStyle,
